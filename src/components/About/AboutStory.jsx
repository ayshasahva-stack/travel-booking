      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-bold text-stone-900 leading-tight">
              Making Every Journey
              <br />
              Simple & Memorable
            </h2>

            <p className="mt-6 text-stone-600 leading-8 text-base sm:text-lg">
            ...
            <div className="grid grid-cols-2 gap-6 mt-10">
              <div>
                ...
                <p className="mt-2 text-stone-500">Destinations</p>
              </div>

              <div>
                <h3 className="text-3xl font-bold text-teal-700">5000+</h3>
                <p className="mt-2 text-stone-500">Happy Travelers</p>
              </div>

              <div>
                <h3 className="text-3xl font-bold text-teal-700">24/7</h3>
                <p className="mt-2 text-stone-500">Customer Support</p>
              </div>

              <div>
                <h3 className="text-3xl font-bold text-teal-700">100%</h3>
                <p className="mt-2 text-stone-500">Secure Booking</p>
              </div>
            </div>
          </div>
